...
function internal:initBroadcastHooks(tbl)
	...
	tbl.fireFinalEffectBuildHooks =       self:buildBroadcastFunc("finalEffectBuildHooks")
	tbl.fireFinalEffectStartHooks =       self:buildBroadcastFunc("finalEffectStartHooks")
	tbl.fireFinalEffectEndHooks =         self:buildBroadcastFunc("finalEffectEndHooks")
	tbl.fireQueuedFinalEffectStartHooks = self:buildBroadcastFunc("queuedFinalEffectStartHooks")
	tbl.fireQueuedFinalEffectEndHooks =   self:buildBroadcastFunc("queuedFinalEffectEndHooks")
	tbl.fireTargetAreaBuildHooks =        self:buildBroadcastFunc("targetAreaBuildHooks")
	tbl.fireSecondTargetAreaBuildHooks =  self:buildBroadcastFunc("secondTargetAreaBuildHooks")
