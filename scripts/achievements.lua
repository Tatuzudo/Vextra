...
local achievements = {
	...
	DNT_PsychoDragonfly = modApi.achievements:add{
		...
		image = mod.resourcePath.."img/achievements/startthefire.png",
		objective = 1,
		global = global,
	...
	DNT_ShockAbsorber = modApi.achievements:add{
		...
		image = mod.resourcePath.."img/achievements/shockabsorber.png",
		objective = 1,
		global = global,
	},
	...
	DNT_UnstableGround = modApi.achievements:add{
		...
		image = mod.resourcePath.."img/achievements/unstableground.png",
		objective = 1,
		global = global,
	},
	...
	DNT_Fartality = modApi.achievements:add{
		...
		image = mod.resourcePath.."img/achievements/fartality.png",
		objective = 1,
		global = global,
		addReward = DNT_checkSquadProgress,
		remReward = DNT_checkSquadProgress,
	...
	DNT_SecretSquad = modApi.achievements:add{
		...
		image = mod.resourcePath.."img/achievements/secretsquad.png",
		secret = true,
		objective = 3,
		global = global,
	},
